...
<form action="./index.php" method="post">
    <div><label>Nom</label><input name="nom"></div>
    <div><label>Prénom</label><input name="prenom"></div>
    <div><label>Mail</label><input name="mail"></div>
    <div><label>Expériences professionnelles</label><input name="experience"></div>
    <div><label>Diplome/Formation</label><input name="diplome"></div>
